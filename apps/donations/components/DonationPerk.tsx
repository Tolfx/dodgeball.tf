  ...
  return (
    ...
    >
      ...
      >
        <Typography variant="h3" component="h1">
          ${props.price}/
          {props.isMonthly ? "month" : props.isPermanent ? "life" : "one-time"}
        </Typography>
      </CardContent>
      <CardContent>
        <Typography
          ...
          <Link
            href={
              process.env.NODE_ENV === "production"
                ? `https://donate.dodgeball.tf/donator?amount=${props.price}`
                : `http://localhost:3004/donator?amount=${props.price}`
            }
          >
            Proceed
          </Link>
