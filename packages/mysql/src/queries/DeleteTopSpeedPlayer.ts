...
export default function DeleteTopSpeedPlayer(steamid: string, serverid?: string)
{
  ...
  const query = `DELETE FROM topspeed.topspeed WHERE steamid = '${steamid}' ${serverid ? ` AND serverid = '${serverid}'` : ''}`;
